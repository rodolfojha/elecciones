<x-layouts.app title="Crear Operador">
    <div class="py-6">
        <div class="mx-auto sm:px-6 lg:px-8 max-w-3xl">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Crear Nuevo Operador</h1>
                <p class="text-gray-600 dark:text-gray-400">Completa los datos del nuevo operador del call center</p>
            </div>
                ...
                <form action="{{ route('users.store') }}" method="POST" class="px-4 py-5 sm:p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input 
                            ...
                            placeholder="operador@callcenter.com"
                            required
                        >
                        @error('email')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
