<x-layouts.app title="Editar Trabajador">
    <div class="py-6">
            ...
            <div class="mb-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">Actualiza los datos de {{ $trabajador->name }}</p>
                    </div>
                </div>
            </div>

            <div class="bg-white overflow-hidden shadow rounded-lg border border-gray-200">
                <form action="{{ route('trabajadores.update', $trabajador) }}" method="POST" class="px-4 py-5 sm:p-6">
                    @csrf
                    @method('PUT')
